...
cmake \
  ...
  -DENABLE_RTREMOTE_DEBUG=ON \
  -DBUILD_RTREMOTE_SAMPLE_APP_SIMPLE=ON \
  ...
  -DCMAKE_CXX_FLAGS="-fsanitize=address -fsanitize-address-use-after-scope -fsanitize-recover=address -fstack-protector-all -fPIE -mmpx -fno-omit-frame-pointer -fno-delete-null-pointer-checks -Wall -Wextra -Werror -Wno-cast-function-type -Wno-class-memaccess -Wno-deprecated-declarations -Wno-sign-compare -Wno-unused-parameter -Wno-deprecated-declarations -Werror=address -Wno-unused-function -DMESA_EGL_NO_X11_HEADERS -O0 -g3 -DUSE_STD_THREADS -DPXSCENE_DISABLE_WST_DECODER -UENABLE_EGL_GENERIC" ..
#  -DCMAKE_CXX_FLAGS="-fsanitize=thread -fPIE -mmpx -fno-omit-frame-pointer -fno-delete-null-pointer-checks -Wall -Wextra -Werror -Wno-cast-function-type -Wno-class-memaccess -Woverloaded-virtual -Wno-deprecated-declarations -Wno-sign-compare -Wno-unused-parameter -Wno-deprecated-declarations -Werror=address -DMESA_EGL_NO_X11_HEADERS -O0 -g3 -DUSE_STD_THREADS -DPXSCENE_DISABLE_WST_DECODER -UENABLE_EGL_GENERIC" ..
